...
import { prototypeState, type TabKey } from '../../state/prototypeState'
...
<template>
  <nav class="cb-tabbar" role="navigation" aria-label="底部主导航">
    <button
      ...
      :class="{ 'cb-tab-item--active': prototypeState.currentTab.value === tab.key }"
      :aria-label="tab.label"
      :aria-selected="prototypeState.currentTab.value === tab.key"
      role="tab"
      @click="prototypeState.setTab(tab.key)"
    >
