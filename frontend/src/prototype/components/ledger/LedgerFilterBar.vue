...
const tempStartDate = ref(prototypeState.ledgerFilters.customStartDate)
const tempEndDate = ref(prototypeState.ledgerFilters.customEndDate)
...
const customDateLabel = computed(() => {
  if (prototypeState.ledgerFilters.datePreset === 'custom') {
    const s = prototypeState.ledgerFilters.customStartDate.slice(5)
    const e = prototypeState.ledgerFilters.customEndDate.slice(5)
    return `${s} ~ ${e}`
  }
  return '区间'
})
...
function selectDate(key: typeof datePresets[number]['key']) {
  prototypeState.ledgerFilters.datePreset = key
}

function openDateRangeModal() {
  tempStartDate.value = prototypeState.ledgerFilters.customStartDate
  tempEndDate.value = prototypeState.ledgerFilters.customEndDate
...
function confirmDateRange() {
  ...
  prototypeState.ledgerFilters.customStartDate = tempStartDate.value
  prototypeState.ledgerFilters.customEndDate = tempEndDate.value
  prototypeState.ledgerFilters.datePreset = 'custom'
  showDateRangeModal.value = false
}

function selectCustomer(id: number | null) {
  prototypeState.ledgerFilters.customerId = id
}
</script>
  ...
  <div class="cb-filter-bar">
    ...
    <div class="cb-filter-row-top">
      ...
      <button
        ...
        :class="{ 'cb-search-trigger-btn--active': showSearchInput || prototypeState.ledgerFilters.searchKeyword }"
        aria-label="展开搜索框"
        title="搜索工单"
      ...
      <div class="cb-date-scroll-row" role="tablist" aria-label="常用日期筛选">
        <button
          ...
          :class="{ 'cb-date-pill--active': prototypeState.ledgerFilters.datePreset === d.key }"
          role="tab"
          :aria-selected="prototypeState.ledgerFilters.datePreset === d.key"
      ...
      <button
        ...
        :class="{ 'cb-range-trigger-btn--active': prototypeState.ledgerFilters.datePreset === 'custom' }"
        role="tab"
        :aria-selected="prototypeState.ledgerFilters.datePreset === 'custom'"
    ...
    <div v-if="showSearchInput" class="cb-search-box-wrap">
      <input
        v-model="prototypeState.ledgerFilters.searchKeyword"
        type="text"
      ...
      />
      <button
        v-if="prototypeState.ledgerFilters.searchKeyword"
        type="button"
        class="cb-search-clear"
        aria-label="清空搜索"
        @click="prototypeState.ledgerFilters.searchKeyword = ''"
      >
        ✕
      </button>
    </div>
    ...
    <div class="cb-cust-full-row">
      <div class="cb-cust-bubbles-scroll" role="radiogroup" aria-label="按客户筛选">
        <button
          ...
          :class="{ 'cb-filter-bubble--active': prototypeState.ledgerFilters.customerId === null }"
          role="radio"
          :aria-checked="prototypeState.ledgerFilters.customerId === null"
        ...
        <button
          ...
          type="button"
          class="cb-filter-bubble cb-pressable"
          :class="{ 'cb-filter-bubble--active': prototypeState.ledgerFilters.customerId === c.customerId }"
          role="radio"
          :aria-checked="prototypeState.ledgerFilters.customerId === c.customerId"
